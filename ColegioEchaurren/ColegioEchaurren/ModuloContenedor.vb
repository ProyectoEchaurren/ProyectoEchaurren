...
Module ModuloContenedor
    ...
    Public Function BuscarRutRealizarPago(ByRef rut As String, ByRef total As Integer) As Boolean
        ...
        Try
            ...
            adapter.SelectCommand = New MySqlCommand("SELECT NombreCompleto, ApePaterno, ApeMaterno, Becado, TipoPago, PorcentajeBeca, Monto, NombreMes, Estado FROM Alumno inner join Mensualidad on Alumno.RutAlumno = mensualidad.RutAlumno WHERE Alumno.RutAlumno = '" & rut & "'", conn)
            adapter.Fill(dataSet)
            ...
            For i = 0 To total
                If dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Marzo" Then
                    RealizarPago.checkMarzo.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Abril" Then
                    RealizarPago.checkAbril.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Mayo" Then
                    RealizarPago.checkMayo.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Junio" Then
                    RealizarPago.checkJunio.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Julio" Then
                    RealizarPago.checkJulio.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Agosto" Then
                    RealizarPago.checkAgosto.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Septiembre" Then
                    RealizarPago.checkSept.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Octubre" Then
                    RealizarPago.checkOctubre.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Noviembre" Then
                    RealizarPago.checkNov.Enabled = False
                ElseIf dataSet.Tables(0).Rows(i)("NombreMes").ToString = "Diciembre" Then
    ...
    Public Function FiltrosAdminAlumnos(ByRef dgv As DataGridView, ByRef rut As String, ByRef nombre As String, ByRef apellido As String, ByRef edad As String, ByRef curso As ComboBox, ByRef salud As ComboBox, ByRef porcentaje As ComboBox)
                            ...
                            If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                                If FormAlumnosMatriculados.cbBecados.Checked = True Then
                                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                    Else
                                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                    End If
                                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and Curso = '" & curso.Text & "'", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                            If FormAlumnosMatriculados.cbBecados.Checked = True Then
                                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Becado = 1 ", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Becado = 0 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "'", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and Becado = 1 ", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and Becado = 0 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Edad = '" & edad & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                        If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                            If FormAlumnosMatriculados.cbBecados.Checked = True Then
                                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                            End If
                        End If
                    ElseIf FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                        If FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and Becado = 1 ", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "' and Becado = 0 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PlanSalud = '" & salud.Text & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Becado = 1 ", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "' and Becado = 0 ", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.txtEdad.Text <> "" Then
                    If FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                        If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                            If FormAlumnosMatriculados.cbBecados.Checked = True Then
                                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                            End If
                        End If
                    End If
                ElseIf FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                    If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                        If FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                        End If
                    End If
                ElseIf FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                    If FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and Becado = 1 ", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "' and Becado = 0 ", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PlanSalud = '" & salud.Text & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Becado = 1 ", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "' and Becado = 0 ", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and NombreCompleto = '" & nombre & "'", conn)
                End If
                ...
                If FormAlumnosMatriculados.txtEdad.Text <> "" Then
                    If FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                        If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                            If FormAlumnosMatriculados.cbBecados.Checked = True Then
                                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                Else
                                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                                End If
                            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE ApePaterno = '" & apellido & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and ApePaterno = '" & apellido & "'", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and ApePaterno = '" & apellido & "'", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Edad = '" & edad & "' and Curso = '" & curso.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and PorcentajeBeca = '" & porcentaje.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and ApePaterno = '" & apellido & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Edad = '" & edad & "' and ApePaterno = '" & apellido & "'", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Edad = '" & edad & "' and ApePaterno = '" & apellido & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PorcentajeBeca = '" & porcentaje.Text & "' and ApePaterno = '" & apellido & "'", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and ApePaterno = '" & apellido & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and ApePaterno = '" & apellido & "'", conn)
                Else
            ...
            ElseIf FormAlumnosMatriculados.txtEdad.Text <> "" Then
                If FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                    If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                        If FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Edad = '" & edad & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                        End If
                    End If
                End If
            ElseIf FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                    If FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 1 ", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "' and Becado = 0 ", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and Curso = '" & curso.Text & "'", conn)
                    End If
                End If
            ElseIf FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                If FormAlumnosMatriculados.cbBecados.Checked = True Then
                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and Becado = 1 ", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "' and Becado = 0 ", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PlanSalud = '" & salud.Text & "'", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and PorcentajeBeca = '" & porcentaje.Text & "' and Becado = 1 ", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Becado = 1 ", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE RutAlumno = '" & rut & "' and Becado = 0 ", conn)
            Else
        ...
        ElseIf FormAlumnosMatriculados.txtNombre.Text <> "" Then
            If FormAlumnosMatriculados.txtApePaterno.Text <> "" Then
                If FormAlumnosMatriculados.txtEdad.Text <> "" Then
                    ...
                    ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PorcentajeBeca = '" & porcentaje.Text & "' and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and NombreCompleto = '" & nombre & "' and ApePaterno = '" & apellido & "'", conn)
                    Else
            ...
            ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PorcentajeBeca = '" & porcentaje.Text & "' and NombreCompleto = '" & nombre & "'", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and NombreCompleto = '" & nombre & "'", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and NombreCompleto = '" & nombre & "'", conn)
            Else
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE NombreCompleto = '" & nombre & "'", conn)
            End If
        ElseIf FormAlumnosMatriculados.txtApePaterno.Text <> "" Then
            If FormAlumnosMatriculados.txtEdad.Text <> "" Then
                If FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                    If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                        If FormAlumnosMatriculados.cbBecados.Checked = True Then
                            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and PlanSalud = '" & salud.Text & "' and ApePaterno = '" & apellido & "'", conn)
                            Else
                                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "' and ApePaterno = '" & apellido & "'", conn)
                            End If
                        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and ApePaterno = '" & apellido & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
        ...
        ElseIf FormAlumnosMatriculados.txtEdad.Text <> "" Then
            If FormAlumnosMatriculados.cbbCurso.Text <> "" Then
                If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                    If FormAlumnosMatriculados.cbBecados.Checked = True Then
                        If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                        Else
                            adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                        End If
                    ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "'", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Edad = '" & edad & "' and Curso = '" & curso.Text & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Edad = '" & edad & "' and Curso = '" & curso.Text & "'", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Edad = '" & edad & "' and Curso = '" & curso.Text & "'", conn)
                End If
            Else
        ...
        ElseIf FormAlumnosMatriculados.cbbCurso.Text <> "" Then
            If FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
                If FormAlumnosMatriculados.cbBecados.Checked = True Then
                    If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                    Else
                        adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                    End If
                ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Curso = '" & curso.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Curso = '" & curso.Text & "' and PorcentajeBeca = '" & porcentaje.Text & "'", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and Curso = '" & curso.Text & "'", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and Curso = '" & curso.Text & "'", conn)
            Else
        ...
        ElseIf FormAlumnosMatriculados.cbBuscarServSalud.Text <> "" Then
            If FormAlumnosMatriculados.cbBecados.Checked = True Then
                If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PorcentajeBeca = '" & porcentaje.Text & "' and PlanSalud = '" & salud.Text & "'", conn)
                Else
                    adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PlanSalud = '" & salud.Text & "'", conn)
                End If
            ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 0 and PlanSalud = '" & salud.Text & "'", conn)
            Else
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE PlanSalud = '" & salud.Text & "'", conn)
            End If
        ElseIf FormAlumnosMatriculados.cbBecados.Checked = True Then
            If FormAlumnosMatriculados.cbbPorcentaje.Text <> "" Then
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1 and PorcentajeBeca = '" & porcentaje.Text & "'", conn)
            Else
                adapter.SelectCommand = New MySqlCommand("SELECT RutAlumno, NombreCompleto, ApePaterno, ApeMaterno, Sexo, FechaNac, Edad, Domicilio, SectorVilla, Comuna, Telefono, ColegioPresedencia, Curso, CursosRepetidos, Becado, PorcentajeBeca, HermanosEstablecimiento, AlumnoViveCon, AntecedentesMedicos, PlanSalud FROM alumno inner join servicio_por_alumno ON alumno.RutAlumno = servicio_por_alumno.Alumno_RutAlumno inner join servicio_salud on servicio_por_alumno.Servicio_salud_idServicio_salud = servicio_salud.idServicio_salud WHERE Becado = 1", conn)
            End If
        ElseIf FormAlumnosMatriculados.cbNoBecados.Checked = True Then
